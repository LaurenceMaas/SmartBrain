...
class Register extends Component{	
	...
	onRegister = () => {
		...
		.then(user => { 	
			...
			if (user === "None of the email,name and password fields may be blank when registering a user") 
			{
				...
				<main className="pa4 black-80">
					<div className="measure">
						...
						<div className="mt3">
							...
							<input className="pa2 input-reset ba bg-transparent hover-bg-transparent hover-transparent w-100 b--black-60" 
							type="text" 
							name="name" 
							id="name"
